...
public class EtlFileUploader2Hdfs {
    private static List<String> titleEaringList = Arrays.asList(
...
//        }
        ...
        for (US_STATES state : US_STATES.values()){
            ...
            fred.writeCsv2Hdfs("householdIncome.csv", etlhouseholdIncomeData);
        ...
        for (int i = 0; i < titleEaringList.size() ; i++){
            for (US_STATES state : US_STATES.values()){
                ...
                String filename = getFileName(titleEaringList.get(0));
