...
public class EtlDataUploader2Kafka {
    public static void main(String[] args) throws Exception{
        ...
        List<String> filenames = Arrays.asList(
                ...
                "earnings_Construction.csv",
                "earnings_Financial_Activities.csv",
                "earnings_Goods_Producing.csv",
                "earnings_Leisure and Hospitality.csv".replace(" ", "_").replace(",", ""),
                "earnings_Manufacturing.csv".replace(" ", "_").replace(",", ""),
                "earnings_Private Service Providing.csv".replace(" ", "_").replace(",", ""),
                "earnings_Professional and Business Services.csv".replace(" ", "_").replace(",", ""),
                "earnings_Trade, Transportation, and Utilities.csv".replace(" ", "_").replace(",", "")
        );
